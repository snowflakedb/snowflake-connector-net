...
where sn.exe
where certutil
echo %SN_KEY% >> "C:\jenkins\workspace\NugetPushDotNetDriverSignTest\decoded.txt"

certutil -f  -decode "C:\jenkins\workspace\NugetPushDotNetDriverSignTest\decoded.txt" "C:\jenkins\workspace\NugetPushDotNetDriverSignTest\data.txt"
