...
namespace Snowflake.Data.Core.Authenticator.WorkflowIdentity
{
    internal abstract class WorkloadIdentityAttestationRetriever
    {
        ...
        /// For AWS: IAM role ARNs (e.g., "arn:aws:iam::123456789012:role/Role1,arn:aws:iam::123456789012:role/Role2").
        /// For Azure: client IDs of user-assigned managed identities.</param>
