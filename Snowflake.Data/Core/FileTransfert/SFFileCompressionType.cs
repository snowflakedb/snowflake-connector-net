    ...
    internal class SFFileCompressionTypes
    {
        ...
        public static SFFileCompressionType guessCompressionType(string filePath)
        {
            ...
            foreach (SFFileCompressionType compType  in compressionTypes)
            {
                ...
                // For brotli type, add fallback logic that detection will depend on file extension. 
                // This is because standard magic number is introduced in v3 format of brotli.
                // https://github.com/madler/brotli/blob/master/br-format-v3.txt
                if (BROTLI.Equals(compType))
                {
