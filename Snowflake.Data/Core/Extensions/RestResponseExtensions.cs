namespace Snowflake.Data.Core.Extensions
{
    internal static class RestResponseExtensions
    {
        ...
        private const int SF_SESSION_NO_LONGER_EXISTS_CODE = 390111;
        ...
        public static bool IsSessionInNoLongerExistsState(this BaseRestResponse r) => r.code == SF_SESSION_NO_LONGER_EXISTS_CODE;
    }
}
