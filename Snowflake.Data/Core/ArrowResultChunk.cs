...
namespace Snowflake.Data.Core
{
    internal class ArrowResultChunk : BaseResultChunk
    {
        ...
        internal static object ExtractArrowValue(IArrowArray array, int index)
        {
            switch (array)
            {
        ...
        internal static Dictionary<string, object> ExtractStructArray(StructArray structArray, int index)
        {
            ...
            for (int i = 0; i < structArray.Fields.Count; i++)
            {
                ...
                var value = ExtractArrowValue(field, index);
        ...
        internal static List<object> ExtractListArray(ListArray listArray, int index)
        {
            ...
            {
                result.Add(ExtractArrowValue(values, i));
            }
        ...
        internal static Dictionary<object, object> ExtractMapArray(MapArray mapArray, int index)
        {
            ...
            {
                var key = ExtractArrowValue(keyArray, i);
                var value = ExtractArrowValue(valueArray, i);
                result[key] = value;
            }
