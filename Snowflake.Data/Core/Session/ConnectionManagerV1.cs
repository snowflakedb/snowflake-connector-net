...
{
    public sealed class ConnectionManagerV1 : IConnectionManager // abstract would make it possible not to have public GetSession or AddSession which are not API of pool
    {
