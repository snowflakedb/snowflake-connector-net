...
namespace Snowflake.Data.Client
{
    public class SnowflakeDbConnectionPool
    {
        ...
        {
            s_logger.LogDebug($"SnowflakeDbConnectionPool::GetSession");
        ...
        {
            s_logger.LogDebug($"SnowflakeDbConnectionPool::GetSessionAsync");
        ...
        {
            s_logger.LogDebug($"SnowflakeDbConnectionPool::GetPool");
        ...
        {
            s_logger.LogDebug($"SnowflakeDbConnectionPool::GetPoolInternal");
            return ConnectionManager.GetPool(connectionString);
        }

        internal static bool AddSession(SFSession session)
        {
            s_logger.LogDebug("SnowflakeDbConnectionPool::AddSession");
            return ConnectionManager.AddSession(session);
        }

        internal static void ReleaseBusySession(SFSession session)
        {
            s_logger.LogDebug("SnowflakeDbConnectionPool::ReleaseBusySession");
            ConnectionManager.ReleaseBusySession(session);
        }

        public static void ClearAllPools()
        {
            s_logger.LogDebug("SnowflakeDbConnectionPool::ClearAllPools");
            ConnectionManager.ClearAllPools();
        }

        public static void SetMaxPoolSize(int maxPoolSize)
        {
            s_logger.LogDebug("SnowflakeDbConnectionPool::SetMaxPoolSize");
        ...
        {
            s_logger.LogDebug("SnowflakeDbConnectionPool::SetTimeout");
            ConnectionManager.SetTimeout(connectionTimeout);
        }

        public static long GetTimeout()
        {
            s_logger.LogDebug("SnowflakeDbConnectionPool::GetTimeout");
            return ConnectionManager.GetTimeout();
        }

        public static int GetCurrentPoolSize()
        {
            s_logger.LogDebug("SnowflakeDbConnectionPool::GetCurrentPoolSize");
        ...
        {
            s_logger.LogDebug("SnowflakeDbConnectionPool::GetPooling");
        ...
        private static void SetConnectionPoolVersion(ConnectionPoolType requestedPoolType, bool force)
        {
            lock (s_connectionManagerInstanceLock)
            {
                ...
                if (requestedPoolType == ConnectionPoolType.MultipleConnectionPool)
                {
                    ...
                    s_logger.LogInformation("SnowflakeDbConnectionPool - multiple connection pools enabled");
                }
                if (requestedPoolType == ConnectionPoolType.SingleConnectionCache)
                {
                    s_connectionManager = new ConnectionCacheManager();
                    s_logger.LogWarning("SnowflakeDbConnectionPool - connection cache enabled");
                }
            }
        }
