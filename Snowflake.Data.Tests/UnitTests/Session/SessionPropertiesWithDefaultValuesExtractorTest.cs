...
namespace Snowflake.Data.Tests.UnitTests.Session
{
    ...
    public class SessionPropertiesWithDefaultValuesExtractorTest
    {
        ...
        {
            // arrange
            var properties = SFSessionProperties.ParseConnectionString("account=test;user=test;password=test;connection_timeout=15", null, null);
        ...
        {
            // arrange
            var properties = SFSessionProperties.ParseConnectionString($"account=test;user=test;password=test", null, null);
            var extractor = new SessionPropertiesWithDefaultValuesExtractor(properties, false);
        ...
        {
            // arrange
            var properties = SFSessionProperties.ParseConnectionString("account=test;user=test;password=test;connection_timeout=15X", null, null);
            var extractor = new SessionPropertiesWithDefaultValuesExtractor(properties, false);
            var defaultValue = GetDefaultIntSessionProperty(SFSessionProperty.CONNECTION_TIMEOUT);
