...
namespace Snowflake.Data.Tests.UnitTests.Authenticator
{
    ...
    public class OAuthAuthorizationCodeAuthenticatorTest
    {
        ...
        {
            // arrange
            var customizedProperties = $"authorization_scope={AuthorizationScope};external_authorization_url={ExternalAuthorizationUrl};external_token_request_url={ExternalTokenUrl};redirect_uri={CustomRedirectUri};";
            var browserRunner = new Mock<IWebBrowserRunner>();
            var listenerStarter = new Mock<WebListenerStarter>();
        ...
        private string GetAuthorizationCodeConnectionString(string additionalConnectionStringPart)
        {
            ...
            var connectionString = new StringBuilder()
                ...
                .Append($"client_id={ClientId};client_secret={ClientSecret};");
