...
public partial class ArrowResultChunkTest
{
    ...
    {
        [SFTheory]
        [InlineData("99999999999999999999999999999", 0, "99999999999999999999999999999")]
        [InlineData("-99999999999999999999999999999", 0, "-99999999999999999999999999999")]
        [InlineData("123456789012345678901234567890", 0, "123456789012345678901234567890")]
        [InlineData("-123456789012345678901234567890", 0, "-123456789012345678901234567890")]
        public void TestExtractDecimal128CellAsStringScaleZero(string rawValue, int scale, string expected)
        {
            ...
            chunk.Next();
            Assert.Equal(expected, chunk.ExtractDecimal128CellAsString(0, scale));
        }

        [SFTheory]
        [InlineData("99999999999999999999999999999", 2, "999999999999999999999999999.99")]
        [InlineData("-99999999999999999999999999999", 2, "-999999999999999999999999999.99")]
        [InlineData("123456789012345678901234567890", 5, "1234567890123456789012345.67890")]
        [InlineData("-123456789012345678901234567890", 5, "-1234567890123456789012345.67890")]
        [InlineData("99999999999999999999999999999999999999", 10, "9999999999999999999999999999.9999999999")]
        ...
        public void TestExtractDecimal128CellAsStringZeroValues()
        {
            ...
            chunk.Next();
            Assert.Equal("0", chunk.ExtractDecimal128CellAsString(0, 0));

            chunk = BuildDecimal128Chunk(BigInteger.Zero, 5);
            chunk.Next();
            Assert.Equal("0.00000", chunk.ExtractDecimal128CellAsString(0, 5));
        }

        [SFTheory]
        [InlineData("79228162514264337593543950336", 0, "79228162514264337593543950336")]
        [InlineData("-79228162514264337593543950336", 0, "-79228162514264337593543950336")]
        [InlineData("79228162514264337593543950336", 2, "792281625142643375935439503.36")]
        [InlineData("-79228162514264337593543950336", 2, "-792281625142643375935439503.36")]
