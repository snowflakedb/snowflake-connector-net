...
declare -A BUILD_IMAGE_NAMES=(
    [$DRIVER_NAME-ubuntu204-net10]=$DOCKER_REGISTRY_NAME/client-$DRIVER_NAME-ubuntu204-net10-build:$BUILD_IMAGE_VERSION
)
export BUILD_IMAGE_NAMES

declare -A TEST_IMAGE_NAMES=(
    [$DRIVER_NAME-ubuntu204-net10]=$DOCKER_REGISTRY_NAME/client-$DRIVER_NAME-ubuntu204-net10-test:$TEST_IMAGE_VERSION
)
