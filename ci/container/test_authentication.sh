...
dotnet restore -p:TargetFrameworks=net9.0 --no-cache -l "console;verbosity=info"
dotnet test --framework net9.0 -p:TargetFrameworks=net9.0 -l "console;verbosity=info" --filter FullyQualifiedName~AuthenticationTests
