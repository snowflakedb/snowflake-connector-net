...
| CLIENT_STORE_TEMPORARY_CREDENTIAL | No       | Specifies whether to cache tokens and use them for external bowser, oauth autorization code flow and oauth client credential flow authentications. The default value is `true` for Windows and `false` on non-Windows platforms.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| OAUTHCLIENTID                     | Depends  | ClientId used for OAuth flows. It is required for OAuth Authorization Code Flow and OAuth Client Credentials Flow.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| OAUTHCLIENTSECRET                 | Depends  | ClientSecret used for OAuth flows. It is required for OAuth Authorization Code Flow and OAuth Client Credentials Flow.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| OAUTHSCOPE                        | Depends  | The requested scope in OAuth flows. If not provided the default value is built based on `role`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| OAUTHAUTHORIZATIONURL             | Depends  | The url of the authorization endpoint (the one to get authorization code) for OAuth Authorization Code Flow. Required for non-Snowflake Identity Providers. Optional for Snowflake used as an Identity Provider because for Snowflake there is a default value.                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| OAUTHTOKENREQUESTURL              | Depends  | The url of the token endpoint (the one to get access token/refresh token) for OAuth Authorization Code Flow or OAuth Client Credential Flow. Required for OAuth Client Credentials Flow. For OAuth Authorization Code Flow, required in case of non-Snowflake Identity Providers, but optional for Snowflake used as an Identity Provider because for Snowflake there is a default value.                                                                                                                                                                                                                                                                                                                                 |
...
The difference from simple OAuth authentication that the driver doesn't get the token from the connection parameters but instead communicates with
