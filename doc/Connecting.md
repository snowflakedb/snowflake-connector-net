...
| OAUTHCLIENTID                     | Depends  | ClientId used for OAuth flows. It is required for OAuth Authorization Code Flow and OAuth Client Credentials Flow. For OAuth Authorization Code Flow and Snowflake used as the Identity provider it can be automatically filled with a default `LOCAL_APPLICATION` value if neither of `OAUTHCLIENTID` and `OAUTHCLIENTSECRET` properties are provided.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| OAUTHCLIENTSECRET                 | Depends  | ClientSecret used for OAuth flows. It is required for OAuth Authorization Code Flow and OAuth Client Credentials Flow. For OAuth Authorization Code Flow and Snowflake used as the Identity provider it can be automatically filled with a default `LOCAL_APPLICATION` value if neither of `OAUTHCLIENTID` and `OAUTHCLIENTSECRET` properties are provided.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
