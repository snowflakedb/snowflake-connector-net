...
| ENABLESINGLEUSEREFRESHTOKENS      | No       | Used in OAuth Authorization Code Flow authentication. The default value is `false`. When set to `true` the driver requests the Identity Provider for single use refresh tokens.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
<br />
