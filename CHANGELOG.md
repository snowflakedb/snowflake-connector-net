...
# Changelog
- v6.0.0
  -  Added default idle timeout (180s) to chunk download stream reads to detect hung connections. Configurable via `SF_CHUNK_DOWNLOAD_IDLE_TIMEOUT` environment variable in seconds; set to `0` to disable.
